        ...
        header("Location: ../", true);
            ...
            if (!isset($_SESSION['inicio_sesion'])) {
                ...
                if ($_SESSION['inicio_sesion']['cargo']=="subdirector" || $_SESSION['inicio_sesion']['cargo']=="coordinador") {
                    ...
                    $buscar_funcionario = "SELECT `documento`, `tipo_documento`, `nombres`, `apellidos`, `ubicacion`, `cargo`, `estado`  FROM `funcionarios` WHERE documento<> '$cc_jefe' ORDER BY `fecha_registro` DESC LIMIT $limite;";
                }else{
                    $buscar_funcionario = "SELECT `documento`, `tipo_documento`, `nombres`, `apellidos`, `ubicacion`, `cargo`, `estado`  FROM `funcionarios` ORDER BY `fecha_registro` DESC LIMIT $limite;";
                }            

...
<head>
    ...
    <script src="../funciones/salidas/funcion_modales_salida.js" type="module"></script>
    ...
    <main id="contenedor-ppl">
        ...
        <section id="contenedor-info">
            ...
            <article id="contenedor-fila-1">
                <h1 id="titulo">Salidas</h1>
                <?php include 'multitud.php';?>
            </article>
            <article id="contenedor-btns" class="contenedor">
                <button class="btn btn-salida" id="btn_peatonal"> 
                    <figure>
                        <img src="../img/peaton.png" alt="">
                    </figure>
                    <h3>Peatonal</h3>
                </button>
                <button class="btn btn-salida" id="btn_vehicular"> 
                    <figure>
            ...
            <article id="contenedor_tabla" class="contenedor">
                <h2 id="titulo_tabla">Ultimas Salidas</h2>
                <table >
                    <thead>
                        <tr>
                            <th>Fecha</th>

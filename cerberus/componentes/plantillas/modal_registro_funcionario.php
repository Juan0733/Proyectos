...
<form action="" method="post" id="forma_registro" name="forma_registro">
    ...
    <article id="contenedor_titulo_icon">
        <h1 id="titulo_r">Registrar Funcionario</h1>
    ...
    <article id="contenedor_inputs">
        ...
        <div class="fila_input">
            <div class="bloque-input">
                <select name="cargo" id="cargo" class="input" tabindex="3" required >
                    ...
                    } elseif ($cargo_usuario == "subdirector") {
                        echo '<option value="instructor">Instructor</option>';
                        echo '<option value="coordinador">Coordinador</option>';
                        echo '<option value="personal administrativo">Personal Administrativo</option>';
                        echo '<option value="asistente">Apoyo tecnico y mantenimiento</option>';
                        echo '<option value="supervisor">Personal de bienestar</option>';
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="fila_input" id="credenciales" style="display: none;">
            <div class="bloque-input">
                <label for="contrasena">contraseña:</label>
                <input class="input" type="password" id="contrasena" name="contrasena" pattern="[A-Za-z0-9]{8,12}" maxlength="12" minlength="8" title="Ingrese solo letras y números, entre 8 y 12 caracteres" tabindex="8" placeholder="eje:juansoto01">
            </div>
            <div class="bloque-input">
                <label for="confirmar">confirmar contraseña:</label>
                <input class="input" type="password" id="confirmar" name="confirmar" pattern="[A-Za-z0-9]{8,12}" maxlength="12" minlength="8" title="Ingrese solo letras y números, entre 8 y 12 caracteres" tabindex="8" placeholder="eje:juansoto01">
